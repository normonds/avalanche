...
public class ALLSWTControls {
   ...
   */
  public ALLSWTControls(Composite parent) {
    initResources();
   ...
   */
  void initResources() {
    final Class clazz = ALLSWTControls.class;
      try {
        if (images == null) {
  ...
  public static void main(String[] args) {
    ...
    ALLSWTControls instance = new ALLSWTControls(shell);
...
class ShellTab extends Tab {
   ...
   */
  ShellTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  public void createButtonSelected(SelectionEvent event) {
    ...
    closeButton.setText(ALLSWTControls.getResourceString("Close"));
    ...
    currentShell.setText(ALLSWTControls.getResourceString("Title")
        + shellCount);
    if (imageButton.getSelection())
      currentShell.setImage(instance.images[ALLSWTControls.ciTarget]);
  ...
  void createControlGroup() {
    ...
    controlGroup.setText(ALLSWTControls.getResourceString("Parameters"));
    ...
    styleGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false,
        1, 3));
    styleGroup.setText(ALLSWTControls
    ...
    modalStyleGroup.setText(ALLSWTControls
    ...
    otherGroup.setText(ALLSWTControls.getResourceString("Other"));
    ...
    parentStyleGroup.setText(ALLSWTControls.getResourceString("Parent"));
  }
  ...
  void createControlWidgets() {
    ...
    noParentButton.setText(ALLSWTControls.getResourceString("No_Parent"));
    parentButton = new Button(parentStyleGroup, SWT.RADIO);
    parentButton.setText(ALLSWTControls.getResourceString("Parent"));
    ...
    imageButton.setText(ALLSWTControls.getResourceString("Image"));

    /* Create the "create" and "closeAll" buttons */
    createButton = new Button(controlGroup, SWT.NONE);
    GridData gridData = new GridData(GridData.HORIZONTAL_ALIGN_END);
    createButton.setLayoutData(gridData);
    createButton.setText(ALLSWTControls.getResourceString("Create_Shell"));
    closeAllButton = new Button(controlGroup, SWT.NONE);
    gridData = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
    closeAllButton.setText(ALLSWTControls
...
abstract class Tab {
  ...
  void createSetGetGroup() {
    ...
    if (methodNames != null) {
      ...
      setGetButton.setText(ALLSWTControls.getResourceString("Set_Get"));
  ...
  void createColorGroup() {
    ...
    colorGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
        | GridData.VERTICAL_ALIGN_FILL));
    colorGroup.setText(ALLSWTControls.getResourceString("Colors"));
    new Label(colorGroup, SWT.NONE).setText(ALLSWTControls
    ...
    fontButton.setText(ALLSWTControls.getResourceString("Font"));
    fontButton.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL));
    Button defaultsButton = new Button(colorGroup, SWT.PUSH);
    defaultsButton.setText(ALLSWTControls.getResourceString("Defaults"));
  ...
  void createOtherGroup() {
    ...
    enabledButton.setText(ALLSWTControls.getResourceString("Enabled"));
    visibleButton = new Button(otherGroup, SWT.CHECK);
    visibleButton.setText(ALLSWTControls.getResourceString("Visible"));
  ...
  void createEventConsolePopup() {
    ...
    cut.setText(ALLSWTControls.getResourceString("MenuItem_Cut"));
    ...
    copy.setText(ALLSWTControls.getResourceString("MenuItem_Copy"));
    ...
    paste.setText(ALLSWTControls.getResourceString("MenuItem_Paste"));
    ...
    selectAll.setText(ALLSWTControls
  ...
  void createListenerSelectionDialog() {
    ...
    dialog.setText(ALLSWTControls.getResourceString("Select_Listeners"));
    ...
    selectAll.setText(ALLSWTControls.getResourceString("Select_All"));
    ...
    deselectAll.setText(ALLSWTControls.getResourceString("Deselect_All"));
    ...
    ok.setText(ALLSWTControls.getResourceString("OK"));
  ...
  void createListenersGroup() {
    ...
    listenCheckbox.setText(ALLSWTControls.getResourceString("Listen"));
    ...
    clearButton.setText(ALLSWTControls.getResourceString("Clear"));
  ...
  void createSetGetDialog(int x, int y, String[] methodNames) {
    ...
    dialog.setText(getTabText() + " "
        + ALLSWTControls.getResourceString("Set_Get"));
  ...
  String parameterInfo(String methodRoot) {
    ...
    String info = ALLSWTControls.getResourceString("Info_" + typeNameString
        + (isArray ? "A" : ""));
    if (isArray) {
      typeNameString += "[]";
    }
    return ALLSWTControls.getResourceString("Parameter_Info", new Object[] {
        typeNameString, info });
  }
  ...
  void createSizeGroup() {
    ...
    sizeGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
        | GridData.VERTICAL_ALIGN_FILL));
    sizeGroup.setText(ALLSWTControls.getResourceString("Size"));
    ...
    preferredButton.setText(ALLSWTControls.getResourceString("Preferred"));
    ...
    fillButton.setText(ALLSWTControls.getResourceString("Fill"));
  ...
  void createStyleGroup() {
    ...
    styleGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
        | GridData.VERTICAL_ALIGN_FILL));
    styleGroup.setText(ALLSWTControls.getResourceString("Styles"));
  }
...
class TreeTab extends ScrollableTab {
  ...
  static String[] columnTitles = {
      ALLSWTControls.getResourceString("TableTitle_0"),
      ALLSWTControls.getResourceString("TableTitle_1"),
      ALLSWTControls.getResourceString("TableTitle_2"),
      ALLSWTControls.getResourceString("TableTitle_3") };

  static String[][] tableData = {
      { ALLSWTControls.getResourceString("TableLine0_0"),
          ALLSWTControls.getResourceString("TableLine0_1"),
          ALLSWTControls.getResourceString("TableLine0_2"),
          ALLSWTControls.getResourceString("TableLine0_3") },
      { ALLSWTControls.getResourceString("TableLine1_0"),
          ALLSWTControls.getResourceString("TableLine1_1"),
          ALLSWTControls.getResourceString("TableLine1_2"),
          ALLSWTControls.getResourceString("TableLine1_3") },
      { ALLSWTControls.getResourceString("TableLine2_0"),
          ALLSWTControls.getResourceString("TableLine2_1"),
          ALLSWTControls.getResourceString("TableLine2_2"),
          ALLSWTControls.getResourceString("TableLine2_3") } };

  /**
   * Creates the Tab within a given instance of ControlExample.
   */
  TreeTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createColorGroup() {
    ...
    itemGroup.setText(ALLSWTControls.getResourceString("Tree_Item_Colors"));
    GridData data = new GridData();
    data.horizontalSpan = 2;
    itemGroup.setLayoutData(data);
    itemGroup.setLayout(new GridLayout(2, false));
    new Label(itemGroup, SWT.NONE).setText(ALLSWTControls
        .getResourceString("Foreground_Color"));
    ...
    itemFontButton.setText(ALLSWTControls.getResourceString("Font"));
  ...
  void createExampleGroup() {
    ...
    imageTreeGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    imageTreeGroup.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      setItemText(item, i, ALLSWTControls.getResourceString("Node_"
          + (i + 1)));
      if (i < 3) {
        TreeItem subitem = new TreeItem(item, SWT.NONE);
        setItemText(subitem, i, ALLSWTControls
            .getResourceString("Node_" + (i + 1) + "_1"));
      }
    }
    TreeItem treeRoots[] = tree1.getItems();
    TreeItem item = new TreeItem(treeRoots[1], SWT.NONE);
    setItemText(item, 1, ALLSWTControls.getResourceString("Node_2_2"));
    item = new TreeItem(item, SWT.NONE);
    setItemText(item, 1, ALLSWTControls.getResourceString("Node_2_2_1"));
    textNode1 = treeRoots[0];
    packColumns(tree1);

    /* Create the image tree */
    tree2 = new Tree(imageTreeGroup, style);
    Image image = instance.images[ALLSWTControls.ciClosedFolder];
    if (multipleColumns.getSelection()) {
      for (int i = 0; i < columnTitles.length; i++) {
...
class ToolBarTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ToolBarTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleGroup() {
    ...
    imageToolBarGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    imageToolBarGroup.setText(ALLSWTControls
    ...
    textToolBarGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    textToolBarGroup.setText(ALLSWTControls
    ...
    imageTextToolBarGroup.setLayoutData(new GridData(
        GridData.GRAB_HORIZONTAL | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    imageTextToolBarGroup.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    item.setText(ALLSWTControls.getResourceString("Push"));
    item.setToolTipText("SWT.PUSH");
    item = new ToolItem(textToolBar, SWT.PUSH);
    item.setText(ALLSWTControls.getResourceString("Push"));
    item.setToolTipText("SWT.PUSH");
    item = new ToolItem(textToolBar, SWT.RADIO);
    item.setText(ALLSWTControls.getResourceString("Radio"));
    item.setToolTipText("SWT.RADIO");
    item = new ToolItem(textToolBar, SWT.RADIO);
    item.setText(ALLSWTControls.getResourceString("Radio"));
    item.setToolTipText("SWT.RADIO");
    item = new ToolItem(textToolBar, SWT.CHECK);
    item.setText(ALLSWTControls.getResourceString("Check"));
    item.setToolTipText("SWT.CHECK");
    item = new ToolItem(textToolBar, SWT.RADIO);
    item.setText(ALLSWTControls.getResourceString("Radio"));
    item.setToolTipText("SWT.RADIO");
    ...
    item.setText(ALLSWTControls.getResourceString("Drop_Down"));
    item.setToolTipText("SWT.DROP_DOWN");
    item.addSelectionListener(new DropDownSelectionListener());
  ...
  void createOtherGroup() {
    ...
    comboChildButton.setText(ALLSWTControls
  ...
  class DropDownSelectionListener extends SelectionAdapter {
    ...
    public void widgetSelected(SelectionEvent event) {
      ...
      if (menu == null) {
        ...
        menu = new Menu(shell);
        for (int i = 0; i < 9; ++i) {
          final String text = ALLSWTControls
...
class TextTab extends ScrollableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  TextTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleWidgets() {
    ...
    text.setText(ALLSWTControls.getResourceString("Example_string")
        + Text.DELIMITER
        + ALLSWTControls.getResourceString("One_Two_Three"));
  }
...
class TableTab extends ScrollableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  TableTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createColorGroup() {
    ...
    itemGroup = new Group(colorGroup, SWT.NONE);
    itemGroup
        .setText(ALLSWTControls.getResourceString("Table_Item_Colors"));
    GridData data = new GridData();
    data.horizontalSpan = 2;
    itemGroup.setLayoutData(data);
    itemGroup.setLayout(new GridLayout(2, false));
  ...
  void createOtherGroup() {
    ...
    moveableColumns.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    for (int i = 0; i < 16; i++) {
      ...
      setItemText(item, i, ALLSWTControls.getResourceString("Index") + i);
    }
    packColumns();
  }
...
class TabFolderTab extends Tab {
  ...
  static String[] TabItems1 = {
      ALLSWTControls.getResourceString("TabItem1_0"),
      ALLSWTControls.getResourceString("TabItem1_1"),
      ALLSWTControls.getResourceString("TabItem1_2") };

  /**
   * Creates the Tab within a given instance of ControlExample.
   */
  TabFolderTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleWidgets() {
    ...
    for (int i = 0; i < TabItems1.length; i++) {
      ...
      content.setText(ALLSWTControls.getResourceString("TabItem_content")
          + ": " + i);
...
class StyledTextTab extends ScrollableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  StyledTextTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  Image createBitmapImage(Display display, String name) {
    InputStream sourceStream = ALLSWTControls.class
        .getResourceAsStream(name + ".bmp");
    InputStream maskStream = ALLSWTControls.class.getResourceAsStream(name
        + "_mask.bmp");
    ImageData source = new ImageData(sourceStream);
  ...
  void createExampleWidgets() {
    ...
    styledText.setText(ALLSWTControls.getResourceString("Example_string"));
    styledText.append("\n");
    styledText.append(ALLSWTControls.getResourceString("One_Two_Three"));
  ...
  void createStyledTextStyleGroup() {
    ...
    styledTextStyleGroup.setText(ALLSWTControls
    ...
    label.setText(ALLSWTControls
        .getResourceString("StyledText_Style_Instructions"));
    data = new GridData(GridData.FILL_HORIZONTAL);
    data.horizontalSpan = 7;
    label.setLayoutData(data);
    new Label(styledTextStyleGroup, SWT.NONE).setText(ALLSWTControls
...
class SpinnerTab extends RangeTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  SpinnerTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createIncrementGroup() {
    ...
    incrementGroup.setText(ALLSWTControls.getResourceString("Increment"));
  ...
  void createPageIncrementGroup() {
    ...
    pageIncrementGroup.setText(ALLSWTControls
  ...
  void createDigitsGroup() {
    ...
    digitsGroup.setText(ALLSWTControls.getResourceString("Digits"));
...
class SliderTab extends RangeTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  SliderTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createThumbGroup() {
    ...
    thumbGroup.setText(ALLSWTControls.getResourceString("Thumb"));
...
abstract class ScrollableTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ScrollableTab(ALLSWTControls instance) {
    super(instance);
  }
...
class SashTab extends Tab {
  ...
  static String[] ListData0 = {
      ALLSWTControls.getResourceString("ListData0_0"),
      ALLSWTControls.getResourceString("ListData0_1"),
      ALLSWTControls.getResourceString("ListData0_2"),
      ALLSWTControls.getResourceString("ListData0_3"),
      ALLSWTControls.getResourceString("ListData0_4"),
      ALLSWTControls.getResourceString("ListData0_5"),
      ALLSWTControls.getResourceString("ListData0_6"),
      ALLSWTControls.getResourceString("ListData0_7"),
      ALLSWTControls.getResourceString("ListData0_8") };

  static String[] ListData1 = {
      ALLSWTControls.getResourceString("ListData1_0"),
      ALLSWTControls.getResourceString("ListData1_1"),
      ALLSWTControls.getResourceString("ListData1_2"),
      ALLSWTControls.getResourceString("ListData1_3"),
      ALLSWTControls.getResourceString("ListData1_4"),
      ALLSWTControls.getResourceString("ListData1_5"),
      ALLSWTControls.getResourceString("ListData1_6"),
      ALLSWTControls.getResourceString("ListData1_7"),
      ALLSWTControls.getResourceString("ListData1_8") };
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  SashTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleWidgets() {
    ...
    text.setText(ALLSWTControls.getResourceString("Multi_line"));
...
class SashFormTab extends Tab {
  ...
  static String[] ListData0 = {
      ALLSWTControls.getResourceString("ListData0_0"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_1"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_2"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_3"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_4"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_5"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_6"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData0_7") }; //$NON-NLS-1$

  static String[] ListData1 = {
      ALLSWTControls.getResourceString("ListData1_0"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_1"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_2"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_3"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_4"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_5"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_6"), //$NON-NLS-1$
      ALLSWTControls.getResourceString("ListData1_7") }; //$NON-NLS-1$

  /**
   * Creates the Tab within a given instance of ControlExample.
   */
  SashFormTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleWidgets() {
    ...
    text.setText(ALLSWTControls.getResourceString("Multi_line")); //$NON-NLS-1$
...
abstract class RangeTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  RangeTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createMaximumGroup() {
    ...
    maximumGroup.setText(ALLSWTControls.getResourceString("Maximum"));
  ...
  void createMinimumGroup() {
    ...
    minimumGroup.setText(ALLSWTControls.getResourceString("Minimum"));
  ...
  void createSelectionGroup() {
    ...
    selectionGroup.setText(ALLSWTControls.getResourceString("Selection"));
...
class ProgressBarTab extends RangeTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ProgressBarTab(ALLSWTControls instance) {
    super(instance);
  }
...
class MenuTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  MenuTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  public void createButtonSelected(SelectionEvent event) {
    ...
    shell.setText(ALLSWTControls.getResourceString("Title") + shellCount);
    shell.addPaintListener(new PaintListener() {
      public void paintControl(PaintEvent e) {
        e.gc.drawString(ALLSWTControls
  ...
  void createControlGroup() {
    ...
    styleGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
        | GridData.VERTICAL_ALIGN_FILL));
    styleGroup.setText(ALLSWTControls.getResourceString("Menu_Styles"));
    ...
    menuItemStyleGroup.setLayoutData(new GridData(
        GridData.HORIZONTAL_ALIGN_FILL | GridData.VERTICAL_ALIGN_FILL));
    menuItemStyleGroup.setText(ALLSWTControls
  ...
  void createControlWidgets() {
    ...
    imagesButton.setText(ALLSWTControls.getResourceString("Images"));
    acceleratorsButton = new Button(otherGroup, SWT.CHECK);
    acceleratorsButton.setText(ALLSWTControls
        .getResourceString("Accelerators"));
    mnemonicsButton = new Button(otherGroup, SWT.CHECK);
    mnemonicsButton.setText(ALLSWTControls.getResourceString("Mnemonics"));
    subMenuButton = new Button(otherGroup, SWT.CHECK);
    subMenuButton.setText(ALLSWTControls.getResourceString("SubMenu"));
    subSubMenuButton = new Button(otherGroup, SWT.CHECK);
    subSubMenuButton
        .setText(ALLSWTControls.getResourceString("SubSubMenu"));
  ...
  String getMenuItemText(String item) {
    ...
    if (mnemonic && accelerator && !cascade) {
      return ALLSWTControls.getResourceString(item + "WithMnemonic")
          + "\tCtrl+Shift+" + acceleratorKey;
    }
    if (accelerator && !cascade) {
      return ALLSWTControls.getResourceString(item) + "\tCtrl+Shift+"
          + acceleratorKey;
    }
    if (mnemonic) {
      return ALLSWTControls.getResourceString(item + "WithMnemonic");
    }
    return ALLSWTControls.getResourceString(item);
  }
...
class ListTab extends ScrollableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ListTab(ALLSWTControls instance) {
    super(instance);
  }
...
class LinkTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  LinkTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleWidgets() {
    ...
    try {
      ...
      link1.setText(ALLSWTControls.getResourceString("LinkText"));
    } catch (SWTError e) {
...
class LabelTab extends AlignableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  LabelTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleGroup() {
    ...
    textLabelGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    textLabelGroup.setText(ALLSWTControls.getResourceString("Text_Labels"));
    ...
    imageLabelGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    imageLabelGroup.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    label1.setText(ALLSWTControls.getResourceString("One"));
    label2 = new Label(textLabelGroup, style);
    label2.setText(ALLSWTControls.getResourceString("Two"));
    label3 = new Label(textLabelGroup, style);
    if (wrapButton.getSelection()) {
      label3.setText(ALLSWTControls.getResourceString("Wrap_Text"));
    } else {
      label3.setText(ALLSWTControls.getResourceString("Three"));
    }
    label4 = new Label(imageLabelGroup, style);
    label4.setImage(instance.images[ALLSWTControls.ciClosedFolder]);
    label5 = new Label(imageLabelGroup, style);
    label5.setImage(instance.images[ALLSWTControls.ciOpenFolder]);
    label6 = new Label(imageLabelGroup, style);
    label6.setImage(instance.images[ALLSWTControls.ciTarget]);
  }
...
class GroupTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  GroupTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createOtherGroup() {
    ...
    titleButton.setText(ALLSWTControls.getResourceString("Title_Text"));
  ...
  void setTitleText() {
    if (titleButton.getSelection()) {
      group1.setText(ALLSWTControls.getResourceString("Title_Text"));
    } else {
      group1.setText("");
    }
    setExampleWidgetSize();
...
class DialogTab extends Tab {
  ...
  static String[] FilterNames = {
      ALLSWTControls.getResourceString("FilterName_0"),
      ALLSWTControls.getResourceString("FilterName_1"),
      ALLSWTControls.getResourceString("FilterName_2"),
      ALLSWTControls.getResourceString("FilterName_3") };

  /**
   * Creates the Tab within a given instance of ControlExample.
   */
  DialogTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createButtonSelected(SelectionEvent event) {
    ...
    if (name.equals(ALLSWTControls.getResourceString("ColorDialog"))) {
      ColorDialog dialog = new ColorDialog(shell, style);
      dialog.setRGB(new RGB(100, 100, 100));
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      RGB result = dialog.open();
      textWidget.append(ALLSWTControls.getResourceString("ColorDialog")
          + Text.DELIMITER);
      textWidget.append(ALLSWTControls.getResourceString("Result",
          new String[] { "" + result })
          + Text.DELIMITER + Text.DELIMITER);
      return;
    }

    if (name.equals(ALLSWTControls.getResourceString("DirectoryDialog"))) {
      DirectoryDialog dialog = new DirectoryDialog(shell, style);
      dialog.setMessage(ALLSWTControls
          .getResourceString("Example_string"));
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      String result = dialog.open();
      textWidget.append(ALLSWTControls
    ...
    if (name.equals(ALLSWTControls.getResourceString("FileDialog"))) {
      FileDialog dialog = new FileDialog(shell, style);
      dialog.setFileName(ALLSWTControls.getResourceString("readme_txt"));
      dialog.setFilterNames(FilterNames);
      dialog.setFilterExtensions(FilterExtensions);
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      String result = dialog.open();
      textWidget.append(ALLSWTControls.getResourceString("FileDialog")
          + Text.DELIMITER);
      textWidget.append(ALLSWTControls.getResourceString("Result",
          new String[] { "" + result })
          + Text.DELIMITER + Text.DELIMITER);
    ...
    if (name.equals(ALLSWTControls.getResourceString("FontDialog"))) {
      FontDialog dialog = new FontDialog(shell, style);
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      FontData result = dialog.open();
      textWidget.append(ALLSWTControls.getResourceString("FontDialog")
          + Text.DELIMITER);
      textWidget.append(ALLSWTControls.getResourceString("Result",
          new String[] { "" + result })
          + Text.DELIMITER + Text.DELIMITER);
    ...
    if (name.equals(ALLSWTControls.getResourceString("PrintDialog"))) {
      PrintDialog dialog = new PrintDialog(shell, style);
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      PrinterData result = dialog.open();
      textWidget.append(ALLSWTControls.getResourceString("PrintDialog")
          + Text.DELIMITER);
      textWidget.append(ALLSWTControls.getResourceString("Result",
          new String[] { "" + result })
          + Text.DELIMITER + Text.DELIMITER);
    ...
    if (name.equals(ALLSWTControls.getResourceString("MessageBox"))) {
      MessageBox dialog = new MessageBox(shell, style);
      dialog.setMessage(ALLSWTControls
          .getResourceString("Example_string"));
      dialog.setText(ALLSWTControls.getResourceString("Title"));
      int result = dialog.open();
      textWidget.append(ALLSWTControls.getResourceString("MessageBox")
          + Text.DELIMITER);
      /*
  ...
  void createControlGroup() {
    ...
    dialogStyleGroup.setText(ALLSWTControls
  ...
  void createControlWidgets() {
    ...
    /* Create the combo */
    String[] strings = { ALLSWTControls.getResourceString("ColorDialog"),
        ALLSWTControls.getResourceString("DirectoryDialog"),
        ALLSWTControls.getResourceString("FileDialog"),
        ALLSWTControls.getResourceString("FontDialog"),
        ALLSWTControls.getResourceString("PrintDialog"),
        ALLSWTControls.getResourceString("MessageBox"), };
    ...
    createButton.setText(ALLSWTControls.getResourceString("Create_Dialog"));
    ...
    buttonStyleGroup.setLayoutData(new GridData(
        GridData.HORIZONTAL_ALIGN_FILL | GridData.VERTICAL_ALIGN_FILL));
    buttonStyleGroup.setText(ALLSWTControls
    ...
    iconStyleGroup.setLayoutData(new GridData(
        GridData.HORIZONTAL_ALIGN_FILL | GridData.VERTICAL_ALIGN_FILL));
    iconStyleGroup.setText(ALLSWTControls.getResourceString("Icon_Styles"));
    ...
    fileDialogStyleGroup.setLayoutData(new GridData(
        GridData.HORIZONTAL_ALIGN_FILL | GridData.VERTICAL_ALIGN_FILL));
    fileDialogStyleGroup.setText(ALLSWTControls
  ...
  void createExampleGroup() {
    ...
    resultGroup.setText(ALLSWTControls.getResourceString("Dialog_Result"));
  }
  ...
  void dialogSelected(SelectionEvent event) {
    ...
    String name = dialogCombo.getText();
    boolean isMessageBox = name.equals(ALLSWTControls
        .getResourceString("MessageBox"));
    boolean isFileDialog = name.equals(ALLSWTControls
...
class CTabFolderTab extends Tab {
  ...
  static String[] CTabItems1 = {
      ALLSWTControls.getResourceString("CTabItem1_0"),
      ALLSWTControls.getResourceString("CTabItem1_1"),
      ALLSWTControls.getResourceString("CTabItem1_2") };
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  CTabFolderTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createColorGroup() {
    ...
    itemFontButton.setText(ALLSWTControls.getResourceString("Item_Font"));
  ...
  void createOtherGroup() {
    ...
    simpleTabButton.setText(ALLSWTControls
    ...
    singleTabButton.setText(ALLSWTControls
    ...
    showMinButton.setText(ALLSWTControls
    ...
    showMaxButton.setText(ALLSWTControls
    ...
    imageButton = new Button(otherGroup, SWT.CHECK);
    imageButton.setText(ALLSWTControls.getResourceString("Set_Image"));
    ...
    unselectedImageButton.setText(ALLSWTControls
    ...
    unselectedCloseButton.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    for (int i = 0; i < CTabItems1.length; i++) {
      ...
      text.setText(ALLSWTControls.getResourceString("CTabItem_content")
          + ": " + i);
  ...
  void setImages() {
    ...
    for (int i = 0; i < items.length; i++) {
      if (setImage) {
        items[i]
            .setImage(instance.images[ALLSWTControls.ciClosedFolder]);
      } else {
...
class CoolBarTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  CoolBarTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createOtherGroup() {
    ...
    lockedButton.setText(ALLSWTControls.getResourceString("Locked"));
  ...
  void createStyleGroup() {
    ...
    itemGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
        | GridData.VERTICAL_ALIGN_FILL));
    itemGroup.setText(ALLSWTControls.getResourceString("Item_Styles"));
...
class ComboTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ComboTab(ALLSWTControls instance) {
    super(instance);
  }
...
class CLabelTab extends AlignableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  CLabelTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleGroup() {
    ...
    textLabelGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    textLabelGroup.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    label1.setText(ALLSWTControls.getResourceString("One"));
    label1.setImage(instance.images[ALLSWTControls.ciClosedFolder]);
    label2 = new CLabel(textLabelGroup, style);
    label2.setImage(instance.images[ALLSWTControls.ciTarget]);
    label3 = new CLabel(textLabelGroup, style);
    label3.setText(ALLSWTControls.getResourceString("Example_string")
        + "\n" + ALLSWTControls.getResourceString("One_Two_Three"));
  }
...
class CComboTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  CComboTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createExampleGroup() {
    ...
    comboGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    comboGroup.setText(ALLSWTControls.getResourceString("Custom_Combo"));
  }
...
class CanvasTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  CanvasTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createOtherGroup() {
    ...
    caretButton.setText(ALLSWTControls.getResourceString("Caret"));
    fillDamageButton = new Button(otherGroup, SWT.CHECK);
    fillDamageButton
        .setText(ALLSWTControls.getResourceString("FillDamage"));
...
class ButtonTab extends AlignableTab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  ButtonTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createControlGroup() {
    ...
    upButton.setText(ALLSWTControls.getResourceString("Up"));
    downButton = new Button(alignmentGroup, SWT.RADIO);
    downButton.setText(ALLSWTControls.getResourceString("Down"));
  ...
  void createExampleGroup() {
    ...
    textButtonGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    textButtonGroup.setText(ALLSWTControls
    ...
    imageButtonGroup
        .setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
            | GridData.HORIZONTAL_ALIGN_FILL
            | GridData.VERTICAL_ALIGN_FILL));
    imageButtonGroup.setText(ALLSWTControls
  ...
  void createExampleWidgets() {
    ...
    button1.setText(ALLSWTControls.getResourceString("One"));
    button2 = new Button(textButtonGroup, style);
    button2.setText(ALLSWTControls.getResourceString("Two"));
    button3 = new Button(textButtonGroup, style);
    button3.setText(ALLSWTControls.getResourceString("Three"));
    button4 = new Button(imageButtonGroup, style);
    button4.setImage(instance.images[ALLSWTControls.ciClosedFolder]);
    button5 = new Button(imageButtonGroup, style);
    button5.setImage(instance.images[ALLSWTControls.ciOpenFolder]);
    button6 = new Button(imageButtonGroup, style);
    button6.setImage(instance.images[ALLSWTControls.ciTarget]);
  }
...
abstract class AlignableTab extends Tab {
   ...
   * Creates the Tab within a given instance of ControlExample.
   */
  AlignableTab(ALLSWTControls instance) {
    super(instance);
  }
  ...
  void createControlGroup() {
    ...
    alignmentGroup.setLayoutData(new GridData(
        GridData.HORIZONTAL_ALIGN_FILL | GridData.VERTICAL_ALIGN_FILL));
    alignmentGroup.setText(ALLSWTControls.getResourceString("Alignment"));

    /* Create the controls */
    leftButton = new Button(alignmentGroup, SWT.RADIO);
    leftButton.setText(ALLSWTControls.getResourceString("Left"));
    centerButton = new Button(alignmentGroup, SWT.RADIO);
    centerButton.setText(ALLSWTControls.getResourceString("Center"));
    rightButton = new Button(alignmentGroup, SWT.RADIO);
    rightButton.setText(ALLSWTControls.getResourceString("Right"));
