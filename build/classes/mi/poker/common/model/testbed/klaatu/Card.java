...
public class Card implements Comparable<Card> {
     ...
     * @see #getInstance(com.CardPair.poker.Card.Rank, com.CardPair.poker.Card.Suit)
     */
    ...
    /**
     * Constructs a card of the specified rank and suit.
     * @param rs a {@link String} of length 2, where the first character is in {@link CardPair.Rank#RANK_CHARS} and
     *           the second is in {@link CardPair.Suit#SUIT_CHARS} (case insensitive).
 ...
 */
     ...
     * @return a {@link String} of length 2 containing a character in {@link CardPair.Rank#RANK_CHARS} denoting this
     *          card&#39;s rank followed by a character in {@link CardPair.Suit#SUIT_CHARS} denoting this
     *          card&#39;s suit.
     */
    @Override
