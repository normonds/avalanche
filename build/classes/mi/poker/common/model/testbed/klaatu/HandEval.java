...
public static final int   PAIR             = HandCategory.PAIR.ordinal() << VALUE_SHIFT;
public static final int   TWO_PAIR         = HandCategory.TWO_PAIR.ordinal() << VALUE_SHIFT;
public static final int   THREE_OF_A_KIND  = HandCategory.THREE_OF_A_KIND.ordinal() << VALUE_SHIFT;
public static final int   STRAIGHT         = HandCategory.STRAIGHT.ordinal() << VALUE_SHIFT;
public static final int   FLUSH            = HandCategory.FLUSH.ordinal() << VALUE_SHIFT;
public static final int   FULL_HOUSE       = HandCategory.FULL_HOUSE.ordinal() << VALUE_SHIFT;
public static final int   FOUR_OF_A_KIND   = HandCategory.FOUR_OF_A_KIND.ordinal() << VALUE_SHIFT;
public static final int   STRAIGHT_FLUSH   = HandCategory.STRAIGHT_FLUSH.ordinal() << VALUE_SHIFT;
