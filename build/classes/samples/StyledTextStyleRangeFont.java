...
public class StyledTextStyleRangeFont {
  ...
  public static void main(String[] args) {
    ...
    StyledText styledText = new StyledText(shell, SWT.V_SCROLL | SWT.WRAP | SWT.BORDER | SWT.MULTI);
    ...
    Font font1 = new Font(shell.getDisplay(), "Trebuchet MS", 32, SWT.NORMAL);
    Font font2 = new Font(display, "Trebuchet MS", 30 * 4 / 5, data.getStyle());
    ...
    int[] ranges = new int[] { 0, 24, 61, 13, 107, 10, 122, 10, 134, 3, 143, 6, 160, 7, 168, 7 };
